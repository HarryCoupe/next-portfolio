...
const inputs = [
  {
    ...
    info: "A Personal project I began following the completion of my portfolio website to learn more about GraphQL API's and create something I would use myself. The website created will have two components. One, an alternate way to view your profile data from the website AniList.co. Two, a system that will compile your top so many rated anime or manga and output the most common reccomendations as a way to expedite the task of deciding what to watch or read next!",
